function [opt_strike1, opt_dip1, opt_rake1, opt_strike2, opt_dip2, opt_rake2,opt_shear_stress, opt_normal_stress, opt_coulomb_stress ] ...
          = OOP_thrust(earthquake_stress,tectonic_stress,friction,skempton,nload,Nslice)
...
opt_coulomb_stress=[];
%
dip=0.5*atand(1/friction);%dip angle in the principal stresses coordinate system
rake=90;
if nload==1
